    ...
    <div className="min-h-screen bg-white dark:bg-black text-zinc-900 dark:text-white font-mono">
      <header className="container mx-auto py-6 px-4 sticky top-0 z-50 backdrop-blur-lg bg-white/50 dark:bg-black/50 border-b border-zinc-200 dark:border-zinc-800">
        <nav className="flex justify-between items-center">
          ...
          <div className="space-x-6 flex items-center">
            <SmoothScrollLink href="#projects" className="hover:text-emerald-400 transition-colors">
              Projects
            </SmoothScrollLink>
            <SmoothScrollLink href="#about" className="hover:text-emerald-400 transition-colors">
              About
            </SmoothScrollLink>
            <SmoothScrollLink href="#skills" className="hover:text-emerald-400 transition-colors">
              Skills
            </SmoothScrollLink>
            <SmoothScrollLink href="#contact" className="hover:text-emerald-400 transition-colors">
              Contact
            </SmoothScrollLink>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        >
          ...
          />
          <AnimatedText
            text="Full-stack developer focused on building clean, user-friendly applications"
          ...
          >
            ...
            <Button className="bg-emerald-400 text-black hover:bg-emerald-500">Contact Me</Button>
          </motion.div>
        </motion.section>

        {/* Projects Section */}
        <section id="projects" className="py-20 scroll-reveal">
          <AnimatedText text="Projects" className="text-3xl font-bold mb-2" typingSpeed={50} showCursor={false} />
          <SectionDivider />
        ...
        <section id="about" className="py-20 scroll-reveal">
          <AnimatedText text="About Me" className="text-3xl font-bold mb-2" typingSpeed={50} showCursor={false} />
          <SectionDivider />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <p className="text-zinc-600 dark:text-gray-400 mb-4">
              I'm a passionate developer with a focus on creating clean, efficient, and user-friendly applications. With
              expertise in both frontend and backend technologies, I enjoy building complete solutions that solve
              real-world problems.
            </p>
            <p className="text-zinc-600 dark:text-gray-400 mb-4">
        ...
        <section id="skills" className="py-20 scroll-reveal">
          <AnimatedText text="Skills" className="text-3xl font-bold mb-2" typingSpeed={50} showCursor={false} />
          <SectionDivider />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <section id="contact" className="py-20 scroll-reveal">
          <AnimatedText text="Contact" className="text-3xl font-bold mb-2" typingSpeed={50} showCursor={false} />
          <SectionDivider />
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="group-hover:text-emerald-400 transition-colors">your.email@example.com</span>
              </motion.a>
              <motion.a
              ...
              >
                ...
                <span className="group-hover:text-emerald-400 transition-colors">github.com/yourusername</span>
              </motion.a>
              <motion.a
              ...
              >
                ...
                <span className="group-hover:text-emerald-400 transition-colors">linkedin.com/in/yourusername</span>
              </motion.a>
            </div>
          </div>
        </section>
...
const projects = [
  ...
  },
  {
    id: "2",
    title: "Project Two",
    description: "An e-commerce platform with payment processing and inventory management.",
